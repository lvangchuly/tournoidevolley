...
import homeCornerLogo from './assets/home-corner-logo.png';

const STORAGE_KEY = 'tournoidevolley-react-vite-V26B';
    ...
    return (
      <div className="home-page">
        <div className="home-corner-brand" aria-label="Informations de contact">
          <img className="home-corner-logo-image" src={homeCornerLogo} alt="Logo Neo Dev Chuly0ne" />
