...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (forceGenerateMainStageAfterBrassage2()) {
      return;
    }
  ...
  function approveRefereeScore(scope, matchId) {
    ...
    function forceGenerateMainStageAfterBrassage2() {
      try {
        ...
        if (allBrassage2Validated && !hasMainStage && typeof generateMainStage === 'function') {
          return generateMainStage() !== false;
        }
      } catch (error) {
        console.error('Erreur génération forcée Principale/Consolante après Brassage 2', error);
      }
      return false;
    }
    ...
    queueMicrotask(() => {
      ...
      if (typeof forceGenerateMainStageAfterBrassage2 === 'function' && forceGenerateMainStageAfterBrassage2()) return;
