  ...
  function renderCompactBrassageBoard(pools, matches, standings, scope) {
    ...
    return (
      <div className="compact-brassage-layout">
        ...
        <aside className="mini-card compact-overall-ranking-column">
