...
function createBrassage2PoolsFromBrassage1(sourcePools, standings, names) {
  ...
  const orderedByPool = names.map((_, index) => getOrderedPoolTeamIds(safeSourcePools[index], standings));
