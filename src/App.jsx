...
export default function App() {
  ...
  function approveRefereeScore(scope, matchId) {
    ...
    const tryGenerateBrassage2AfterValidation = () => {
      try {
        if (scope !== 'brassage1') return false;
        ...
        const brassage1Done = currentBrassage1Matches.length > 0
          && currentBrassage1Matches.every((m) => getMatchStatusLabel(m, phaseRulesRef.current) === 'Valide');
        if (!brassage1Done || !brassage2Empty) return false;
