...
export default function App() {
  ...
  const showPublicPrincipalePoolRanking = (principalPhaseGenerated || consolantePhaseGenerated) && principalePublicRanking.length > 0;
  const showPublicConsolantePoolRanking = (principalPhaseGenerated || consolantePhaseGenerated) && consolantePublicRanking.length > 0;
  const showSplitPublicPoolRankings = (principalPhaseGenerated || consolantePhaseGenerated) && (showPublicPrincipalePoolRanking || showPublicConsolantePoolRanking);
