...
function hasNonZeroLiveScore(match) {
  if (!match) return false;
...
function isMatchCurrentlyInProgress(match, phaseRules) {
  ...
  return Boolean(hasNonZeroLiveScore(match) || match.refereeInProgress || match.matchInProgress);
}
