...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (!shouldSkipBrassage2 && stageValidation.brassage2Complete && mainStageRef.current.principaleMatches.length === 0 && mainStageRef.current.consolanteMatches.length === 0) {
